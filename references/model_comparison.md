...
> 最后更新：2026-07-04  
> 对比模型：wan2.7-image-pro / wan2.7-image vs qwen-image-2.0 vs z-image-turbo
...
| `size`（尺寸） | 1k/2k/portrait/landscape | 512-2048 自定义 | portrait/landscape/hd/1k | 输出图片分辨率 | `size="2048*2048"` |
...
| 2048×2048 (2K方形) | ✅ | ✅ | ❌ | wan/qwen 支持 |
| **4K (3840×2160)** | ❌ | ❌ | ❌ | **三者均不支持 4K 分辨率** |
| 默认分辨率 | `1024*1024` | `2048*2048` | `1120*1440` | qwen 默认最高清 |

> ⚠️ **分辨率限制**：三个模型最高都只支持 **2K (2048×2048)** 分辨率，不支持 4K (3840×2160) 或更高分辨率。如需 4K 输出，需要后期通过 AI 放大工具（如 Real-ESRGAN）进行超分辨率处理。
...
|------|:------:|:------:|:------:|:------:|------|
| 📸 写实照片 | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | qwen/z-image | 基于实际生成效果 |
| 🎨 艺术插画 | ⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐ | wan/qwen | 基于实际生成效果 |
| 📊 信息图/图表 | ⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ❌ | qwen-image-2.0 | 基于实际生成效果 |
| 📝 文字排版 | ⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐ | qwen-image-2.0 | 基于实际生成效果 |
...
| `qwen-image-2.0` | `default` | Qwen 视觉多模态，文字渲染强，多图融合 |
